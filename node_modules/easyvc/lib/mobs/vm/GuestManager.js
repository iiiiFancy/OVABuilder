...
class GuestManager {
	...
	//////////////////////////////////////////////////////////////////////////////////////////////
	_auth() {
		let svc = this.vm._serviceDirect()
		return svc.vim.NamePasswordAuthentication({
			username: this.user,
	...
	async runProgram(programPath, args, timeoutMs) {

		let script =`
@echo off
powershell "& {$user = '${this.user}';$password = '${this.password}';` +
'$securePassword = ConvertTo-SecureString $password -AsPlainText -Force;' +
'$creds = New-Object System.Management.Automation.PSCredential -ArgumentList $user, $securePassword;' +
`$ps = Start-Process -PassThru -FilePath '${programPath}' -Credential $creds -ArgumentList '${args}';` +
'$ps.WaitForExit()}"'

		return this.run(script, timeoutMs)
	}
